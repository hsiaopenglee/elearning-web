...
import online.shixun.demo.elearning.dto.UserRoleExample.Criteria;
import online.shixun.demo.elearning.dto.UserRoleExample.Criterion;
...
public class UserRoleSqlProvider {
    ...
    public String countByExample(UserRoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("so_user_role");
