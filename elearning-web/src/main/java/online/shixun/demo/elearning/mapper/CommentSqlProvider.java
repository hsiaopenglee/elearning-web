...
import online.shixun.demo.elearning.dto.CommentExample.Criteria;
import online.shixun.demo.elearning.dto.CommentExample.Criterion;
...
public class CommentSqlProvider {
    ...
    public String countByExample(CommentExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("so_comment");
    ...
    public String insertSelective(Comment record) {
        ...
        if (record.getReplyCommentId() != null) {
            sql.VALUES("reply_comment_id", "#{replyCommentId,jdbcType=BIGINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getReplyCommentId() != null) {
            sql.SET("reply_comment_id = #{record.replyCommentId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Comment record) {
        ...
        if (record.getReferenceId() != null) {
            sql.SET("reference_id = #{referenceId,jdbcType=BIGINT}");
        }
        
        if (record.getReplyCommentId() != null) {
            sql.SET("reply_comment_id = #{replyCommentId,jdbcType=BIGINT}");
        }
